  ...
  return (
    <div className="filter-overlay">
      <div className="filter-choose">
        <h2 className="filter-choose-header">Choose filters</h2>
        ...
        <div className="filter-category">
          ...
          <div className="dino-type">
            ...
            {filterable.typeOfDinosaur.map((item) => (
              <button type="button" key={item} onClick={() => setFilterSelect(`typeOfDinosaur: ${item}`)}>{item}</button>
            ))}
          </div>
          ...
          <div className="dino-diet">
            ...
            {filterable.diet.map((item) => (
              <button type="button" key={item} onClick={() => setFilterSelect(`diet: ${item}`)}>{item}</button>
            ))}
          </div>
          <div className="dino-lived">
            <h3>Period</h3>
            {filterable.whenLived.map((item) => (
              <button type="button" key={item} onClick={() => setFilterSelect(`whenLived: ${item}`)}>{item}</button>
            ))}
          </div>
          <div className="dino-country">
            <h3>Country</h3>
            {filterable.foundIn.map((item) => (
              <button type="button" key={item} onClick={() => setFilterSelect(`foundIn: ${item}`)}>{item}</button>
            ))}
          </div>
          <div className="dino-species">
            <h3>Species</h3>
            {filterable.typeSpecies.map((item) => (
              <button type="button" key={item} onClick={() => setFilterSelect(`typeSpecies: ${item}`)}>{item}</button>
            ))}
          </div>
